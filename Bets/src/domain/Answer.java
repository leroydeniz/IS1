...
public class Answer implements Serializable {
	...
	public Apuesta addDummyBet(Float pselectedAmount, Cliente pselectedClient, Date pselectedDay) {
		
		Apuesta ap = new Apuesta(this, pselectedAmount, pselectedDay, pselectedClient);
		apuestas.add(ap);
		return ap;
