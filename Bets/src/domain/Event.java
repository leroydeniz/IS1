...
public class Event implements Serializable {
	...
	public Event(Integer eventNumber, String description,Date eventDate, Deporte deporte) {
	...
	public void setTipoDeporte(Deporte pTipoDeporte) {
		this.tipoDeporte = pTipoDeporte;
	}
