...
//	private JButton jButtonClose = new JButton(ResourceBundle.getBundle("Etiquetas").getString("Close"));
	...
	private final JLabel lblDefinirResultados = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("SetResultsGUI.lblDefinirResultados.text")); //$NON-NLS-1$ //$NON-NLS-2$
...
//					public void propertyChange(PropertyChangeEvent propertychangeevent) {
		...
		jComboBoxEvents.setBounds(288, 79, 250, 20);
		jComboBoxEvents.setModel(modelEvents);
		jComboBoxEvents.setEnabled(false);
		jComboBoxQuestions.setBounds(288, 143, 250, 20);
		jComboBoxQuestions.setEnabled(false);
		...
		jCalendar.setBounds(40, 80, 225, 150);

		this.getContentPane().add(jCalendar);
		jLabelEventDate.setBounds(40, 45, 140, 25);
		getContentPane().add(jLabelEventDate);
		lblSeleccionarPregunta.setBounds(294, 111, 155, 20);
		...
		jComboBoxAnswers.setBounds(293, 207, 250, 20);
		...
		lblSeleccionarRespuesta.setBounds(293, 175, 245, 25);
		getContentPane().add(lblSeleccionarRespuesta);
		lblSeleccionarEvento.setBounds(288, 47, 268, 20);
		...
		lblDefinirResultados.setHorizontalAlignment(SwingConstants.CENTER);
		lblDefinirResultados.setFont(new Font("Lucida Grande", Font.PLAIN, 16));
		lblDefinirResultados.setBounds(211, 6, 155, 26);
		
		getContentPane().add(lblDefinirResultados);
