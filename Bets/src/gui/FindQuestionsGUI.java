...
public class FindQuestionsGUI extends JFrame {
	...
	private void jbInit() throws Exception
	{
		...
		jButtonClose.setBounds(new Rectangle(343, 435, 155, 37));
		...
		scrollPaneQueries.setBounds(new Rectangle(82, 257, 629, 173));
