...
public class MovimientosCuentaGUI extends JFrame {
	...
	private JLabel lblMovimientosDeCuenta;
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			textArea.setBounds(43, 45, 614, 254);
			...
			jContentPane.add(getLblMovimientosDeCuenta());
		}
		return jContentPane;
	}
	...
	private JLabel getLblNewLabel() {
		if (jLabelSelectOption == null) {
			...
			jLabelSelectOption.setBounds(434, 306, 223, 29);
	...
	private JLabel getLblMovimientosDeCuenta() {
		if (lblMovimientosDeCuenta == null) {
			lblMovimientosDeCuenta = new JLabel("Movimientos de Cuenta");
			lblMovimientosDeCuenta.setHorizontalAlignment(SwingConstants.CENTER);
			lblMovimientosDeCuenta.setFont(new Font("Lucida Grande", Font.PLAIN, 16));
			lblMovimientosDeCuenta.setBounds(224, 6, 249, 26);
		}
		return lblMovimientosDeCuenta;
	}
