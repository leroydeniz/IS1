...
public class CreateQuestionGUI extends JFrame {
	...
	private JLabel jLabelMinBet = new JLabel("Apuesta mínima: ");
	...
	private final JLabel lblCrearPregunta = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("CreateQuestionGUI.lblCrearPregunta.text")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	private void jbInit(Vector<domain.Event> v) throws Exception {
		...
		this.setSize(new Dimension(604, 337));
		...
		jComboBoxEvents.setBounds(new Rectangle(303, 99, 250, 20));
		jLabelListOfEvents.setBounds(new Rectangle(304, 67, 277, 20));
		jLabelQuery.setBounds(new Rectangle(303, 131, 75, 20));
		jTextFieldQuery.setBounds(new Rectangle(303, 163, 250, 20));
		jLabelMinBet.setBounds(new Rectangle(300, 208, 130, 20));
		jTextFieldPrice.setBounds(new Rectangle(422, 208, 130, 20));

		jCalendar.setBounds(new Rectangle(40, 95, 225, 150));
		scrollPaneEvents.setBounds(new Rectangle(25, 44, 346, 116));

		jButtonCreate.setBounds(new Rectangle(409, 272, 153, 30));
		...
		jButtonClose.setBounds(new Rectangle(40, 272, 153, 30));
		...
		jLabelEventDate.setBounds(40, 65, 140, 25);
		getContentPane().add(jLabelEventDate);
		lblCrearPregunta.setHorizontalAlignment(SwingConstants.CENTER);
		lblCrearPregunta.setFont(new Font("Lucida Grande", Font.PLAIN, 16));
		lblCrearPregunta.setBounds(175, 6, 249, 26);
		
		getContentPane().add(lblCrearPregunta);

		// Code for JCalendar
		this.jCalendar.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent propertychangeevent) {
//				this.jCalendar.addPropertyStock.ChangeListener(new PropertyChangeListener() {
//					public void propertyChange(PropertyChangeEvent propertychangeevent) {
