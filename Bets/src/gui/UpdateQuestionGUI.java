...
public class UpdateQuestionGUI extends JFrame {
	...
	private final JLabel lblEditarPregunta = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("UpdateQuestionGUI.lblEditarPregunta.text")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	private void jbInit(Vector<Event> v) throws Exception {
		...
		jComboBoxEvents.setBounds(460, 86, 250, 20);
		...
		preguntaModificar.setBounds(460, 170, 250, 20);
		...
		jLabelEventDate.setBounds(42, 53, 140, 25);
		getContentPane().add(jLabelEventDate);
		lblSeleccionarPresgunta.setBounds(293, 129, 155, 20);
		jButtonCreate.setEnabled(false);
		
		getContentPane().add(lblSeleccionarPresgunta);

		
		jComboBoxQuestions.setBounds(460, 130, 250, 20);
		...
		lblSeleccionarEvento.setBounds(293, 85, 155, 20);
		
		getContentPane().add(lblSeleccionarEvento);
		lblRespuestaModificar.setBounds(291, 172, 151, 16);
		...
		lblCoeficienteDeGanancia.setBounds(291, 212, 167, 16);
		...
		apuestaMinima.setBounds(460, 210, 250, 20);
		...
		lblEditarPregunta.setHorizontalAlignment(SwingConstants.CENTER);
		lblEditarPregunta.setFont(new Font("Lucida Grande", Font.PLAIN, 16));
		lblEditarPregunta.setBounds(291, 6, 140, 26);
		
		getContentPane().add(lblEditarPregunta);
