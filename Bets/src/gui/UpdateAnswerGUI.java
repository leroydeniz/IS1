...
public class UpdateAnswerGUI extends JFrame {
	...
	private final JLabel lblEditarRespuesta = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("UpdateAnswerGUI.lblEditarRespuesta.text")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	private void jbInit(Vector<Event> v) throws Exception {
		...
		jComboBoxEvents.setBounds(459, 67, 250, 20);
		jComboBoxEvents.setModel(modelEvents);
		jComboBoxEvents.setEnabled(false);
		jComboBoxQuestions.setBounds(459, 108, 250, 20);
		...
		lblSeleccionarPresgunta.setBounds(290, 109, 155, 20);
		...
		jComboBoxAnswers.setBounds(459, 152, 250, 20);
		...
		lblSeleccionarRespuesta.setBounds(290, 149, 155, 20);
		getContentPane().add(lblSeleccionarRespuesta);
		lblSeleccionarEvento.setBounds(292, 67, 155, 20);
		...
		lblEditarRespuesta.setHorizontalAlignment(SwingConstants.CENTER);
		lblEditarRespuesta.setFont(new Font("Lucida Grande", Font.PLAIN, 16));
		lblEditarRespuesta.setBounds(302, 6, 140, 26);
		
		getContentPane().add(lblEditarRespuesta);
