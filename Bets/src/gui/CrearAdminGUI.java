...
public class CrearAdminGUI extends JFrame {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			resultDialog.setBounds(211, 233, 129, 29);
			jContentPane.add(resultDialog);
			
			JLabel lblNombre = new JLabel("Nombre: ");
			lblNombre.setBounds(21, 73, 178, 16);
			...
			textFieldUsername.setBounds(211, 96, 278, 26);
			...
			textFieldEmail.setBounds(211, 124, 278, 26);
			...
			passwordField.setBounds(211, 152, 278, 26);
			jContentPane.add(passwordField);
			
			passwordField_1 = new JPasswordField();
			passwordField_1.setHorizontalAlignment(SwingConstants.CENTER);
			passwordField_1.setBounds(211, 182, 278, 26);
			jContentPane.add(passwordField_1);
			
			JLabel lblRepassword = new JLabel("Re-Password: ");
			lblRepassword.setBounds(21, 185, 129, 16);
			jContentPane.add(lblRepassword);
			
			JLabel lblCrearUsuarioAdmin = new JLabel("Crear usuario admin");
			lblCrearUsuarioAdmin.setHorizontalAlignment(SwingConstants.CENTER);
			lblCrearUsuarioAdmin.setFont(new Font("Lucida Grande", Font.PLAIN, 16));
			lblCrearUsuarioAdmin.setBounds(122, 6, 249, 26);
			jContentPane.add(lblCrearUsuarioAdmin);
