	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			ComboBoxPago.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (ComboBoxPago.getSelectedItem().equals(clientedb.getTarjeta())) {
			...
			lblCargarMonedero.setFont(new Font("Lucida Grande", Font.PLAIN, 16));
			lblCargarMonedero.setBounds(204, 9, 249, 26);
			...
			btnAceptar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					try {
						...
						if (ComboBoxPago.getSelectedItem().equals(clientedb.getTarjeta()) && pin.getText().length()!=3) {
