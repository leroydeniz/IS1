...
public interface BLFacade  {
	...
	@WebMethod public Vector<Event> getNextEvents();
	...
	@WebMethod public int createApuesta(Answer selectedAnswer, Cliente selectedClient, Float selectedAmount);
	...
	@WebMethod public boolean insertAnswer(String pAnswer, float pCoeficienteFloat, Question q);
	...
	@WebMethod public boolean updateEvent(Event selectedEvent, String text, Deporte selectedDeporte);

	@WebMethod public boolean deleteEvent(Event selectedEvent);

	@WebMethod public Vector<Deporte> getSports();

	@WebMethod public Vector<Deporte> getActiveSports();
	
	@WebMethod public boolean updateSports(Deporte pDeporte, String pNombre);

	@WebMethod public boolean deleteSport(Deporte selectedItem);

	@WebMethod public ArrayList<Apuesta> getApuestas();

	@WebMethod public int addSport(String pNombre);
